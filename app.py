...
app.layout = html.Div([
    html.H1(children='Gross domestic product at market prices',style={'text-align':'center','font-family':'monospace'}),
    #FIRST GRAPH
    html.Div([
        html.H2(children='Scatter Plot',style={'text-align':'center','font-family':'monospace'}),
        html.Div([
            html.Div([
                dcc.Dropdown(
                    id='xaxis-column',
    ...
    #SECOND GRAPH
    html.Div([
        html.H2(children='Line Chart',style={'margin-top':'5%','text-align':'center','font-family':'monospace'}),
        html.Div([
            html.Div([
                dcc.Dropdown(
                    id='indicator-select',
